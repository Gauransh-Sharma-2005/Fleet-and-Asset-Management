    ...
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-6 h-20 flex items-center justify-between gap-2">
        ...
        >
          ...
          <span className="text-lg sm:text-xl font-black tracking-tight text-white font-outfit truncate">
        ...
        <div className="flex items-center space-x-3">
          {view !== 'admin' && (
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-semibold text-slate-300 hover:text-white border border-white/8 bg-white/4 hover:bg-white/8 px-2.5 sm:px-4 py-2 rounded-lg transition-all duration-200 shrink-0"
            >
          ...
          {isGuest && (
            <a
              href="#monitor"
              className="hidden sm:block gradient-bg btn-primary text-white text-sm font-bold px-5 py-2.5 rounded-lg shadow-lg shadow-indigo-500/20 transition-all duration-300"
            >
              Get Started
            </a>
          )}
