...
export default function AdminDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 sm:mb-12 pb-5 sm:pb-6 border-b border-indigo-500/10">
        <div className="space-y-1.5">
          ...
          <h1 className="text-2xl sm:text-4xl font-black text-white font-outfit">Secure Control Terminal</h1>
          <p className="text-slate-400 text-xs sm:text-sm">Manage system parameters, inject diagnostics, and broadcast emergency alerts.</p>
        </div>
        <button
          onClick={logout}
          className="btn-primary bg-red-950/40 hover:bg-red-900/60 text-rose-400 border border-red-500/30 px-4 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold flex items-center justify-center gap-2 w-full sm:w-auto active:scale-95 transition-all"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        {/* Panel 1: sliders */}
        <div className="glass hover-glow p-5 sm:p-7 rounded-2xl sm:rounded-3xl border border-indigo-500/10 space-y-6 sm:space-y-7">
          <h2 className="text-sm sm:text-base font-bold text-white flex items-center gap-2 font-outfit border-b border-white/5 pb-3 sm:pb-4">
        ...
        <div className="glass hover-glow p-5 sm:p-7 rounded-2xl sm:rounded-3xl border border-indigo-500/10 space-y-5 sm:space-y-6">
          <h2 className="text-sm sm:text-base font-bold text-white flex items-center gap-2 font-outfit border-b border-white/5 pb-3 sm:pb-4">
            <Settings2 className="w-4 h-4 text-purple-400" />
            Simulator Node Controls
          </h2>

          <div className="flex items-center justify-between bg-slate-950/50 p-3.5 sm:p-4 rounded-xl sm:rounded-2xl border border-white/5">
            <div>
            ...
            <button
              ...
              className={`text-[10px] font-bold font-mono px-3 py-1.5 rounded-lg transition-all border active:scale-95 ${
                simNodeOnline
          ...
          <div className="space-y-2.5">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-slate-950/80 border border-white/10 text-white text-base sm:text-sm rounded-xl px-4 py-3 focus:outline-none focus:border-purple-500 font-mono transition-colors"
              />
              <button
                onClick={() => applyTempOverride(tempVal)}
                className="gradient-bg btn-primary text-white px-4 py-3 rounded-xl text-xs font-bold shrink-0 shadow-md shadow-purple-500/15 active:scale-95 transition-all"
              >
                Apply
              </button>
            </div>
          ...
          <button
            ...
            className="w-full btn-primary bg-red-950/40 hover:bg-red-900/60 text-rose-400 border border-red-500/30 py-3.5 rounded-xl text-xs font-bold flex items-center justify-center gap-2 active:scale-95 transition-all"
          >
        ...
        <div className="glass hover-glow p-5 sm:p-7 rounded-2xl sm:rounded-3xl border border-indigo-500/10 space-y-5 sm:space-y-6 md:col-span-2 lg:col-span-1">
          <h2 className="text-sm sm:text-base font-bold text-white flex items-center gap-2 font-outfit border-b border-white/5 pb-3 sm:pb-4">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Enter emergency message for all operators..."
              className="w-full bg-slate-950/80 border border-white/10 text-white text-base sm:text-sm rounded-xl p-3.5 focus:outline-none focus:border-pink-500 font-sans placeholder-slate-700 transition-colors resize-none"
            />
          </div>
          ...
          <button
            ...
            className="w-full gradient-bg btn-primary text-white py-3.5 rounded-xl font-bold text-sm shadow-xl shadow-pink-500/15 flex items-center justify-center gap-2 active:scale-95 transition-all"
          >
            <Megaphone className="w-4 h-4" />
            Broadcast System Alert
          </button>
          <p className="text-[9px] text-slate-600 font-mono">Injects a real-time event into the live exceptions feed.</p>

          <button
            onClick={() => navigateTo('guest')}
            className="w-full text-xs text-indigo-400 hover:text-white transition-colors font-mono flex items-center justify-center gap-1.5 pt-1"
          >
